return {
  ...
  config = function()
    ...
    vim.keymap.set({ "n", "x" }, "<M-a>", function() require("opencode").ask("", { submit = true }) end, { desc = "Ask opencode…" })
    ...
    vim.keymap.set("n", "+", "<M-a>", { desc = "Increment under cursor", noremap = true })
    vim.keymap.set("n", "-", "<M-x>", { desc = "Decrement under cursor", noremap = true })
  end,
}
